...
public class CustomerDAO
{
    ...
    public void createCustomer(Customer customer)
    {
        ...
        try{
            ...
            ((PreparedStatement) stmt).setString(7, customer.getState());
    ...
    public void createTable(){
        try {
            ...
            String query = " Create table if not exists " + " app_customer "
                    + " (id bigint NOT NULL , "
                    + " name text , " + " phone_number decimal , "
                    + " address text , "
                    + " email_id text , " + " city text , "
                    + " state text , " + " created_at timestamp , "
